...
CryptoEnclave_Include_Paths := -IInclude -ICryptoEnclave -I$(SGX_SDK)/include -I$(SGX_SDK)/include/libcxx -I$(SGX_SDK)/include/tlibc -I$(SGXSSL_INCLUDE_PATH) -include "tsgxsslio.h" -I/usr/local/include
